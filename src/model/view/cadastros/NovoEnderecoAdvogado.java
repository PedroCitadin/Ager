 ...
 * @author Pedro
 */
public class NovoEnderecoAdvogado extends javax.swing.JFrame {

    /**
     * Creates new form NovoEndereço
     */
    public NovoEnderecoAdvogado(Advogado adv) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     edao.inserirEnderecoAdvogado(end);
     this.dispose();
                            }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NovoEnderecoAdvogado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NovoEnderecoAdvogado().setVisible(true);
            }
        });
    }
