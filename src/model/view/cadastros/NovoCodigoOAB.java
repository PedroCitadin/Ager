 ...
 * @author Pedro
 */
public class NovoCodigoOAB extends javax.swing.JFrame {

    /**
     * Creates new form NovoEndereço
     */
    public NovoCodigoOAB(Advogado adv) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createMatteBorder(3, 3, 3, 3, new java.awt.Color(0, 0, 0)), "OAB", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Segoe UI", 0, 14))); // NOI18N

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel8.setText("Código OAB:");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addComponent(coab, javax.swing.GroupLayout.DEFAULT_SIZE, 267, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jLabel1.setText("Novo Código OAB");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      if(!cod.getText().equalsIgnoreCase("")){
        ...
        advo.setCod_adv(Integer.parseInt(cod.getText()));
        oab.setCod_advogado(advo);
        oab.setCodigo(coab.getText());
        oDAO.inserirCodigoOab(oab);  
      }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NovoCodigoOAB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NovoCodigoOAB().setVisible(true);
            }
        });
    }
