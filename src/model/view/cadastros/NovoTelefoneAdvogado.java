 ...
 * @author Pedro
 */
public class NovoTelefoneAdvogado extends javax.swing.JFrame {

    /**
     * Creates new form NovoEndereço
     */
    public NovoTelefoneAdvogado(Advogado adv) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      tDAO.inserirTelefoneAdvogado(tel);
      this.dispose();
            }else{ 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NovoTelefoneAdvogado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NovoTelefoneAdvogado().setVisible(true);
            }
        });
    }
