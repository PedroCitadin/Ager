 ...
 * @author Pedro
 */
public class NovoTelefoneCliente extends javax.swing.JFrame {

    /**
     * Creates new form NovoEndereço
     */
    public NovoTelefoneCliente(Cliente cli) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createMatteBorder(3, 3, 3, 3, new java.awt.Color(0, 0, 0)), "Telefone", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 14))); // NOI18N
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tele, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel5Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {ddd, tele});

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Novo Telefone");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (!ddd.getText().equalsIgnoreCase(" ")) {
            if (!tele.getText().equalsIgnoreCase(" ")) {
      ...
      tDAO.inserirTelefoneCliente(tel);
      this.dispose();
            }else{ 
                JOptionPane.showMessageDialog(rootPane, "O campo Telefone está em branco, digite o Telefone");
                            
            }
        }else{
            JOptionPane.showMessageDialog(rootPane, "O campo DDD está em branco, digite o DDD");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NovoTelefoneCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NovoTelefoneCliente().setVisible(true);
            }
        });
    }
